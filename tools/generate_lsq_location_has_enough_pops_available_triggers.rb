...
def build_switch_trigger_text(building_to_pop_type)
  lines = []
  lines << "# AUTO-GENERATED FILE. DO NOT EDIT BY HAND."
  lines << "# Generated by tools/generate_lsq_location_has_enough_pops_available_triggers.rb"
  lines << "# Root is the location, also expects scope:building_type and the scope country"
  lines << "lsq_location_has_enough_pops_available = {"
